      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3 border-t border-primary/10 pt-6">
          <div>
            ...
            <p className="mt-1 text-2xl font-semibold text-foreground">{name}</p>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs font-medium text-muted-foreground">AGE</p>
              <p className="mt-1 text-lg font-semibold text-foreground">{age} years</p>
            </div>
            <div>
              <p className="text-xs font-medium text-muted-foreground">TYPE</p>
              <p className="mt-1 text-lg font-semibold text-foreground">{consultationType}</p>
            </div>
          </div>
        </div>
